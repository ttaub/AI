...
/**  Board Gui mad by Tom Taubkin
 */
 
// =============================MUST IMPLEMENT KEYLISTENER ====================
public class Board extends JPanel implements KeyListener
{
  private static final int X_DIM = 50;
  private static final int Y_DIM = 50;
  ...
  public Board (int rows, int cols)
  {
    ...
    JFrame f = new JFrame( "Checkers AI" );
   ...
   */
  /*returns if this is a valid cell for which there is a move */
